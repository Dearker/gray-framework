 ...
 *
 * @author wenchangwei
 * @since 2022/8/31 10:01 PM
 */
public class ReferenceBeanBuilder extends AnnotatedInterfaceConfigBeanBuilder<ReferenceBean> {

    // Ignore those fields
    private static final String[] IGNORE_FIELD_NAMES = of("application", "module", "consumer", "monitor", "registry");
